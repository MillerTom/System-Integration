...
//            if (commandArray[i].compareToIgnoreCase(action) == 0) {
//                found = true;
//                actionCode = i;
//                logger.info("The command argument===> action=" + action + " ; actionCode =" + actionCode);
//            }
//        }
//        if (found) {
//            executeCmd(args, actionCode);
//        } else {
//            logger.severe("  Unrecognized action: " + action + "\n");
//            return;
//        }
//    }
//
...
//
//        switch (actionCode) {
//            case 0: {//"UploadJobEnd2End"
//
//                if (args.length < 3) {
//                    System.out.println(" UploadJobEnd2End Action Command Usage: UploadJobEnd2End <uploadFilePath> <downloadFilePath>");
//                    return;
//                }
...
//                } else {
//                    logger.severe("UploadJobEnd2End failed.");
//                }
//            }
//            break;
//            case 1: {// "UploadFile"
//                if (args.length < 3) {
//                    System.out.println(" UploadFile Action Command Usage : UploadFile <jobId> <fileRefId> <uploadFilePath>");
//                    return;
//                }
//                jobId = args[1];
//                fileRefId = args[2];
...
//            {
//                if (args.length < 4) {
//                    System.out.println(" DownloadFile Action Command Usage : DownloadFile <jobId> <fileRefId> <downloadFilePath>");
//                    return;
//                }
//                jobId = args[1];
//                fileRefId = args[2];
...
//            case 4: {//"abortJob"
//                if (args.length < 2) {
//                    System.out.println(" abordtJob Action Command Usage : abordJob <jobId>");
//                    return;
//                }
//                jobId = args[1];
...
//            }
//            break;
//            case 5: {//"creatUploadJob"
//                if (args.length < 2) {
//                    System.out.println(" creatUploadJob Action Command Usage : creatUploadJob <jobType>");
//                    return;
//                }
//                jobType = args[1];
...
//            }
//            break;
//            case 6: {//"startUploadJob"
//                if (args.length < 2) {
//                    System.out.println(" startUploadJob Action Command Usage : startUploadJob <jobId>");
//                    return;
//                }
//                jobId = args[1];
...
//            case 7: {//"getJobStatus"
//                if (args.length < 2) {
//                    System.out.println(" getJobStatus Action Command Usage : getJobStatus <jobId>");
//                    return;
//                }
//                jobId = args[1];
...
//
//            break;
//            case 8: { //"startDownloadJob"
//                if (args.length < 2) {
//                    System.out.println(" getJobStatus Action Command Usage : startDownloadJob <jobType>");
//                    return;
//                }
...
//            }
//            break;
//            case 9: { //"end2EndDownloadJob"
//                if (args.length < 3) {
//                    System.out.println(" end2EndDownloadJob Action Command Usage : end2EndDownloadJob <jobType> <downloadFilePath>");
//                    return;
//                }
//                if (args.length == 3) {
//                    jobType = args[1];
...
//        sb.append("\n");
//
//        sb.append("#2: java -jar LMSSample.jar DownloadJobEnd2End SoldReport downloadResult.zip \n");
//        sb.append("--------------------------------------------------------------------------------\n");
//        sb.append("Input parameters\n");
...
//        sb.append("\n");
//        sb.append("\n");
//        sb.append("#3: java -jar LMSSample.jar createUploadJob ReviseFixedPriceItem\n");
//        sb.append("----------------------------------------------------------------\n");
//        sb.append("Input parameters:\n");
...
//        sb.append("\n");
//        sb.append("\n");
//        sb.append("#4: java -jar LMSSample.jar UploadFile 5000000636 50000000236 D:/ReviseFixedPriceItem.xml \n");
//        sb.append("------------------------------------------------------------------------------------------\n");
//        sb.append("Input parameters:\n");
...
//        sb.append("\n");
//        sb.append("\n");
//        sb.append("#5: java -jar LMSSample.jar startUploadJob 5000000636\n");
//        sb.append("-----------------------------------------------------\n");
//        sb.append("Input parameters:\n");
...
//        sb.append("\n");
//        sb.append("\n");
//        sb.append("#6: java -jar LMSSample.jar getJobStatus 5000000636\n");
//        sb.append("----------------------------------------------------\n");
//        sb.append("Input parameters:\n");
...
//        sb.append("\n");
//
//        sb.append("#7: a> java -jar LMSSample.jar startDownloadJob SoldReport\n");
...
//        sb.append("\n");
//        sb.append("\n");
//        sb.append("#8: java -jar LMSSample.jar DownloadFile 5000000636 50000000236 D:/downloadResult.zip \n");
//        sb.append("--------------------------------------------------------------------------------------\n");
//        sb.append("Input parameters:\n");
...
//
//
//        sb.append("#9: java -jar LMSSample.jar getJobs creationTimeFrom=2008-09-01&creationTimeTo=2008-10-02&jobType=RelistFixedPriceItem&jobStatus=Failed\n");
//        sb.append("---------------------------------------------------------------------------------------------------------------------------------------\n");
//        sb.append("Input parameters:\n");
...
//        sb.append("\n");
//
//        sb.append("#10: java -jar LMSSample.jar abortJob 5000000636\n");
//        sb.append("------------------------------------------------\n");
//        sb.append("Input parameters:\n");
